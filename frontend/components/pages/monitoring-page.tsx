...
import {downloadReport, useAgencyStats, useDistrictsStats} from "@/lib/api/hooks/use-core-api";
                                ...
                                <div className="h-72">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={districtBarData}>
                                            ...
                                            />
                                            <Legend/>
                                            <Bar className="" dataKey="yoshlar" name="Yoshlar"
                                                 fill="hsl(var(--primary))" radius={[4, 4, 0, 0]}/>
                                            <Bar dataKey="bajarildi" name="Bajarilgan" fill="hsl(var(--accent))"
                                                 radius={[4, 4, 0, 0]}/>
                                        </BarChart>
                                    </ResponsiveContainer>
                                </div>
                                        ...
                                        <TableRow key={district.districtId}>
                                            ...
                                            <TableCell className="text-center">
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <span
                                                        className="text-sm">{Math.round(district.completionRate)}%</span>
                                                </div>
                                            </TableCell>
                                            <TableCell className="text-center">
                        <span
                                ...
                                <div className="h-64">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={trendData}>
                                            ...
                                            />
                                            <Legend/>
                                            <Line type="monotone" dataKey="yoshlar" name="Yoshlar"
                                                  stroke="hsl(var(--primary))" strokeWidth={2} dot={{r: 4}}/>
                                            <Line type="monotone" dataKey="score" name="AI ball"
                                                  stroke="hsl(var(--accent))" strokeWidth={2} dot={{r: 4}}/>
                                        </LineChart>
                                    </ResponsiveContainer>
                                </div>
                            </CardContent>
